...
from .modules.unet_modules_common import InitConv,EncoderBlock,DecoderBlock,FinalConv,ResNet_Each_Conv,ResBlock,FinalLoss_Crack,ResBlock_Norml,DecoderBlock_Conv1,Attention_block,ResNet_First_Conv,mid_output_get,Augmented_Attention_block,DecoderBlock_CBAM,cbam
...
class UNet(nn.Module):
    ...
    # def __init__(self):
        ...
        self.decode_1 = DecoderBlock_CBAM(inC=encode_4_out_ch, trpC=encode_4_out_ch,
        ...
        self.decode_2 = DecoderBlock_CBAM(inC=decode_1_out_ch, trpC=decode_1_out_ch,
        ...
        self.attention_GAP=cbam(in_channel=encode_4_out_ch)

        self.decode_3 = DecoderBlock_CBAM(inC=decode_2_out_ch, trpC=decode_2_out_ch,
        ...
        self.decode_4 = DecoderBlock_CBAM(inC=decode_3_out_ch, trpC=decode_3_out_ch,
    ...
    def forward(self, input_):
        ...
        encode_4_end = self.attention_GAP(encode_4)
